...
void HUD_InitClientWeapons( void )
{
	...
	// Fake functions
	g_engfuncs_h.pfnPrecacheModel = stub_PrecacheModel;
	g_engfuncs_h.pfnPrecacheSound = stub_PrecacheSound;
	g_engfuncs_h.pfnPrecacheEvent = stub_PrecacheEvent;
	g_engfuncs_h.pfnNameForFunction = stub_NameForFunction;
	g_engfuncs_h.pfnSetModel = stub_SetModel;
	g_engfuncs_h.pfnSetClientMaxspeed = HUD_SetMaxSpeed;

	// Handled locally
	g_engfuncs_h.pfnPlaybackEvent = HUD_PlaybackEvent;
	g_engfuncs_h.pfnAlertMessage = AlertMessage;

	// Pass through to engine
	g_engfuncs_h.pfnPrecacheEvent = gEngfuncs.pfnPrecacheEvent;
	g_engfuncs_h.pfnRandomFloat = gEngfuncs.pfnRandomFloat;
	g_engfuncs_h.pfnRandomLong = gEngfuncs.pfnRandomLong;
