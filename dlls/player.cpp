...
void CBasePlayer::Spawn( void )
{
	...
	g_engfuncs_h.pfnSetPhysicsKeyValue( edict(), "slj", "0" );
	g_engfuncs_h.pfnSetPhysicsKeyValue( edict(), "hl", "1" );
	g_engfuncs_h.pfnSetPhysicsKeyValue( edict(), "fr", "1" );
	g_engfuncs_h.pfnSetPhysicsKeyValue( edict(), "bj", bhopcap.value ? "0" : "1" );
...
int CBasePlayer::Restore( CRestore &restore )
{
	...
	if( m_fLongJump )
	{
		g_engfuncs_h.pfnSetPhysicsKeyValue( edict(), "slj", "1" );
	}
	else
	{
		g_engfuncs_h.pfnSetPhysicsKeyValue( edict(), "slj", "0" );
	...
	case 107:
		{
			...
			edict_t *pWorld = g_engfuncs_h.pfnPEntityOfEntIndex( 0 );
...
void CBasePlayer::SetPrefsFromUserinfo( char *infobuffer )
{
	...
	pszKeyVal = g_engfuncs_h.pfnInfoKeyValue( infobuffer, "cl_autowepswitch" );
...
{
	edict_t *pEdict = g_engfuncs_h.pfnPEntityOfEntIndex( 1 );
	CBaseEntity *pEntity;
	float bestdot;
	Vector bestdir;
	edict_t *bestent;
...
void CStripWeapons::Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	{
		pPlayer = (CBasePlayer *)CBaseEntity::Instance( g_engfuncs_h.pfnPEntityOfEntIndex( 1 ) );
	}
