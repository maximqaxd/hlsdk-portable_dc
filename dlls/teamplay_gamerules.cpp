...
const char *CHalfLifeTeamplay::SetDefaultPlayerTeam( CBasePlayer *pPlayer )
{
	...
	char *mdls = g_engfuncs_h.pfnInfoKeyValue( g_engfuncs_h.pfnGetInfoKeyBuffer( pPlayer->edict() ), "model" );
...
void CHalfLifeTeamplay::ChangePlayerTeam( CBasePlayer *pPlayer, const char *pTeamName, BOOL bKill, BOOL bGib )
{
	...
	g_engfuncs_h.pfnSetClientKeyValue( clientIndex, g_engfuncs_h.pfnGetInfoKeyBuffer( pPlayer->edict() ), "model", pPlayer->m_szTeamName );
	g_engfuncs_h.pfnSetClientKeyValue( clientIndex, g_engfuncs_h.pfnGetInfoKeyBuffer( pPlayer->edict() ), "team", pPlayer->m_szTeamName );
...
void CHalfLifeTeamplay::ClientUserInfoChanged( CBasePlayer *pPlayer, char *infobuffer )
{
	...
	char *mdls = g_engfuncs_h.pfnInfoKeyValue( infobuffer, "model" );
