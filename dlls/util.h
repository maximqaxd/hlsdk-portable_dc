...
inline edict_t *ENT(EOFFSET eoffset)			{ return (*g_engfuncs_h.pfnPEntityOfEntOffset)(eoffset); }
...
#endif
	return (*g_engfuncs_h.pfnEntOffsetOfPEntity)(pent); 
}
...
inline int	  ENTINDEX(edict_t *pEdict)			{ return (*g_engfuncs_h.pfnIndexOfEdict)(pEdict); }
inline edict_t* INDEXENT( int iEdictNum )		{ return (*g_engfuncs_h.pfnPEntityOfEntIndex)(iEdictNum); }
inline void MESSAGE_BEGIN( int msg_dest, int msg_type, const float *pOrigin, entvars_t *ent ) {
	(*g_engfuncs_h.pfnMessageBegin)(msg_dest, msg_type, pOrigin, ENT(ent));
}
...
#define UTIL_EntitiesInPVS(pent)			(*g_engfuncs_h.pfnEntitiesInPVS)(pent)
...
{
	g_engfuncs_h.pfnAngleVectors( vecAngles, p_vForward, p_vRight, p_vUp );
}
...
#define CVOXFILESENTENCEMAX CVOXFILESENTENCEMAX_GOLDSOURCE_LEGACY // max number of sentences in game. NOTE: this must match
