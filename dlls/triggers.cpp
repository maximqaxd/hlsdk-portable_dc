...
void PlayCDTrack( int iTrack )
{
	...
	pClient = g_engfuncs_h.pfnPEntityOfEntIndex( 1 );
...
void CChangeLevel::ChangeLevelNow( CBaseEntity *pActivator )
{
	...
	CBaseEntity *pPlayer = CBaseEntity::Instance( g_engfuncs_h.pfnPEntityOfEntIndex( 1 ) );
...
void CTriggerEndSection::EndSectionUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	if( pev->message )
	{
		g_engfuncs_h.pfnEndSection( STRING( pev->message ) );
	}
	UTIL_Remove( this );
}
...
void CTriggerCamera::Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	{
		pActivator = CBaseEntity::Instance( g_engfuncs_h.pfnPEntityOfEntIndex( 1 ) );
	}
